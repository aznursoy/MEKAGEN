...
#ifndef KALBOT_INTERFACES__MSG__MOTOR_COMMAND__STRUCT_HPP_
#define KALBOT_INTERFACES__MSG__MOTOR_COMMAND__STRUCT_HPP_
...
struct MotorCommand_
{
  ...
  explicit MotorCommand_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit MotorCommand_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // KALBOT_INTERFACES__MSG__MOTOR_COMMAND__STRUCT_HPP_
