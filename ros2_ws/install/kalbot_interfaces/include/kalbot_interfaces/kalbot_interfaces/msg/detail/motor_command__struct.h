...
#ifndef KALBOT_INTERFACES__MSG__DETAIL__MOTOR_COMMAND__STRUCT_H_
#define KALBOT_INTERFACES__MSG__DETAIL__MOTOR_COMMAND__STRUCT_H_
...
#endif  // KALBOT_INTERFACES__MSG__DETAIL__MOTOR_COMMAND__STRUCT_H_
