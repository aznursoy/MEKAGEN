    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'kalbot_interfaces.msg.MotorCommand')
            logger.debug(
...
class MotorCommand(metaclass=Metaclass_MotorCommand):
    ...
    _fields_and_field_types = {
        'left_motor_speed': 'int64',
        'right_motor_speed': 'int64',
    }
    ...
    def left_motor_speed(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'left_motor_speed' field must be an integer in [-9223372036854775808, 9223372036854775807]"
    ...
    def right_motor_speed(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'right_motor_speed' field must be an integer in [-9223372036854775808, 9223372036854775807]"
