...
#include "kalbot_interfaces/msg/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kalbot_interfaces, msg, MotorCommand)();
}
