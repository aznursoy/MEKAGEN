...
static const _SetMotorSpeed_Request_type_support_symbol_names_t _SetMotorSpeed_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kalbot_interfaces, srv, SetMotorSpeed_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kalbot_interfaces, srv, SetMotorSpeed_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kalbot_interfaces, srv, SetMotorSpeed_Request)() {
  return &::kalbot_interfaces::srv::rosidl_typesupport_c::SetMotorSpeed_Request_message_type_support_handle;
}
...
static const _SetMotorSpeed_Response_type_support_symbol_names_t _SetMotorSpeed_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kalbot_interfaces, srv, SetMotorSpeed_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kalbot_interfaces, srv, SetMotorSpeed_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kalbot_interfaces, srv, SetMotorSpeed_Response)() {
  return &::kalbot_interfaces::srv::rosidl_typesupport_c::SetMotorSpeed_Response_message_type_support_handle;
}
...
static const _SetMotorSpeed_type_support_symbol_names_t _SetMotorSpeed_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kalbot_interfaces, srv, SetMotorSpeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kalbot_interfaces, srv, SetMotorSpeed)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, kalbot_interfaces, srv, SetMotorSpeed)() {
  return &::kalbot_interfaces::srv::rosidl_typesupport_c::SetMotorSpeed_service_type_support_handle;
}
