...
#include "kalbot_interfaces/srv/detail/set_motor_speed__rosidl_typesupport_fastrtps_c.h"
...
static size_t _SetMotorSpeed_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kalbot_interfaces__srv__SetMotorSpeed_Request(
...
static size_t _SetMotorSpeed_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kalbot_interfaces__srv__SetMotorSpeed_Response(
    full_bounded, is_plain, 0);
