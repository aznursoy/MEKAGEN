...
#include "kalbot_interfaces/srv/set_motor_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_SetMotorSpeed_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_SetMotorSpeed_Response(full_bounded, 0);
}
